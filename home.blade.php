...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="info-box">
			<button class="button button1" style="width:100%">
                <span class="info-box-icon bg-aqua"><i class="ion ion-android-mail"></i></span>

                <div class="info-box-content">
					<br>
                    <span class="info-box-text" valign="middle">Jumlah <br>SIMARU</span>
                    <span class="info-box-number">{{$content['jumlahSurat']}}</span>
                </div>
			</button>		
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
					<br>
                    <span class="info-box-text">SIMARU<br>Tervalidasi</span>
                    <span class="info-box-number">{{$content['suratTervalidasi']}}</span>
                </div>
            </div>
			</button>		
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
					<br>
                    <span class="info-box-text">SIMARU Belum<br> Tervalidasi</span>
                    <span class="info-box-number">{{$content['suratBelumTervalidasi']}}</span>
                </div>
			</button>		
            </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
			...
			<button class="button button1" style="width:100%">
                ...
                <div class="info-box-content">
					<br>
                    <span class="info-box-text">SIMARU<br>Revisi</span>
                    <span class="info-box-number">{{$content['suratRevisi']}}</span>
                </div>
			</button>	
            </div>
        </div>
