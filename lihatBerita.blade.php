                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-xs-6" style="padding: 0px 9px 2px 10px">
                                            <a href="{{route('get-setAktifBerita',['id' => $berita->id])}}">
                                                <button type="button"
                                        ...
                                        <div class="col-xs-6 " style="padding: 0px 12px 2px 7px">
                                            <a href="{{route('get-setPasifBerita',['id' => $berita->id])}}')}}">
                                                <button type="button"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6" style="padding: 2px 9px 0px 10px">
                                            <a href="{{route('get-editBerita',['id' => $berita->id])}}">
                                                <button type="button"
                                        ...
                                        <div class="col-xs-6" style="padding: 2px 12px 0px 7px">
                                            <a href="{{route('get-hapusBerita',['id' => $berita->id])}}')}}">
                                                <button type="button"
