        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Data NDA PIC Telkom Akses</h3>
                </div>
                <!-- /.box-header -->
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-xs-12 " style="padding: 0px 12px 2px 12px">
                                            <a href="{{route('get-lihatNda',['path' => ($pic->statusNda == 1 ? $pic->nda->pathUri : 'null')])}}">
                                                <button type="button"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6" style="padding: 2px 7px 0px 12px">
                                            <a href="{{route('get-indexUploadNda',['id' => $pic->id])}}">
                                                <button type="button"
                                        ...
                                        <div class="col-xs-6" style="padding: 2px 12px 0px 7px">
                                            <a href="{{route('get-hapusNda',['id' => $pic->id])}}">
                                                <button type="button"
    ...
    <script>
        $(function () {
            ...
            $('.hapus').on('click', function () {
                return confirm('Hapus NDA petugas dengan nama ' + $(this).val() + '?')
            });
