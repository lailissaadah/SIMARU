        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Data PIC SIGMA</h3>
                ...
                <div class="box-body table-responsive" >
                    <table id="table1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        @foreach($picSigmas as $picSigma)
                            <tr>
                                <td>{{$picSigma->nama}}</td>
                                <td>{{$picSigma->kontak}}</td>
                                <td>{{$picSigma->unitPerusahaan->namaUnit}}</td>
                                <td>
                                    <div class="row">
                                        <div class="col-xs-6" style="padding: 0px 7px 0px 12px">
                                            <a href="{{route('get-editPicSigma',['id' => $picSigma->id])}}">
                                                <button type="submit"
                                        ...
                                        <div class="col-xs-6" style="padding: 0px 12px 0px 7px">
                                            <a href="{{route('get-hapusPicSigma',['id' => $picSigma->id])}}')}}">
                                                <button type="submit"
