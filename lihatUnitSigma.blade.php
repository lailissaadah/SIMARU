        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Data Unit SIGMA</h3>
                ...
                <div class="box-body table-responsive" >
                    <table id="table1" class="table table-bordered table-striped">
                        ...
                        @foreach($unitSigmas as $unitSigma)
                            <tr>
                                <td>{{$unitSigma->namaUnit}}</td>
                                <td>
                                    <div class="row">
                                        <div class="col-xs-6" style="padding: 0px 7px 0px 12px">
                                            <a href="{{route('get-editUnitSigma',['id' => $unitSigma->id])}}">
                                                <button type="submit"
